...
@Component({
  selector: 'app-patrimonio-movimentacoes',
  standalone: false,
  templateUrl: './patrimonio-movimentacoes.html',
  styleUrl: './patrimonio-movimentacoes.css',
})
export class PatrimonioMovimentacoes implements OnInit {
  todasMovimentacoes = [
