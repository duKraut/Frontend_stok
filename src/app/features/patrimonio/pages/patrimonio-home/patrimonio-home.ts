...
export class PatrimonioHome implements OnInit{
  todosAtivos = [
    ...
    { tombamento: '#PAT-00156', nome: 'Cadeira Ergonômica Pro', desc: 'Ajuste de Lombar e Braços', marca: 'GenioDesk', aquisicao: '20/01/2021', depto: 'Financeiro', estado: 'BOM', estadoClass: 'badge-bom', valor: 'R$ 1.200,00' },
    { tombamento: '#PAT-00045', nome: 'Projetor Epson X41', desc: 'Sala de Reunião A', marca: 'Epson', perigo: true, aquisicao: '05/06/2018', depto: 'Adm.', estado: 'SUBSTITUIR', estadoClass: 'badge-substituir', valor: 'R$ 800,00' },
    { tombamento: '#PAT-00210', nome: 'Servidor PowerEdge R740', desc: 'Rack 01 - Data Center', marca: 'Microsoft', aquisicao: '10/11/2023', depto: 'TI - Infra', estado: 'EXCELENTE', estadoClass: 'badge-excelente', valor: 'R$ 45.000,00' },
    { tombamento: '#PAT-00211', nome: 'Monitor Dell 24"', desc: 'IPS Full HD', marca: 'Dell', aquisicao: '12/11/2023', depto: 'TI - Infra', estado: 'EXCELENTE', estadoClass: 'badge-excelente', valor: 'R$ 1.000,00' }
  ];
