...
@Component({
  selector: 'app-almoxarifado-movimentacao-form',
  standalone: false,
  templateUrl: './almoxarifado-movimentacao-form.html',
  styleUrl: './almoxarifado-movimentacao-form.css',
})
export class AlmoxarifadoMovimentacaoForm implements OnInit {
